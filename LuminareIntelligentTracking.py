...
def start_gui(camera_idx: int, number_of_leds: int = 256, numbmer_of_sections: int = 8, host:str = '', port: str = '', 
              object_detect_status: bool = False, model_path: str='', label_path: str='', use_tpu: bool = False, background_images_dir: str = r'BackgroundImages', hand_gesture_recogin: bool = True)->multiprocessing.Process:
...
if __name__ == '__main__':
    ...
    if performance_status:
        ...
        subsystem_one = LITSubsystemData(0, number_of_leds=256, number_of_sections=8, image_preview_height=396, image_preview_width=704)
        subsystem_two = LITSubsystemData(2, number_of_leds=256, number_of_sections=8, image_preview_height=396, image_preview_width=704)
